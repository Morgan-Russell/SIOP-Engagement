---
title             : "Development of an Intentionally Bi-factor Engagement Measure"
...
Participant job title, hours worked per week, and organizational tenure were recorded. Mean hours worked per week was `r mean(together$hours, na.rm=TRUE)` (SD = `r sd(together$hours, na.rm=TRUE)`), see Figure \@ref(fig:hours). Mean organizational tenure was `r mean(together$tenure, na.rm = TRUE)` (SD = `r sd(together$tenure, na.rm = TRUE)`), see Figure \@ref(fig:tenure). Participants who did not exactly specify their tenure (e.g. "A bit over a year") were not included in this average.
...
```{r jobs, echo=FALSE, warning=FALSE, fig.cap="ISCO professional categories of participants"}
...
mod <- apa_table(mod2, caption = "Attitudinal structure modification indices (36 item analysis)", align = c("m{2cm}","m{2cm}","m{2cm}","m{7cm}"))
mod
```
